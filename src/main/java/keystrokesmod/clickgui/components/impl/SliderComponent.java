...
public class SliderComponent extends Component {
    ...
    private static final float TRACK_CORNER_RADIUS = 1.0f;
    private static final int TRACK_BACKGROUND = new Color(34, 8, 52, 172).getRGB();
    private static final int TRACK_FILL = new Color(184, 92, 255, 220).getRGB();
