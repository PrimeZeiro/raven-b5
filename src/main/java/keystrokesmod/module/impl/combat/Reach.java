...
public class Reach extends Module {
    ...
    public static boolean shouldUseReachDistance() {
        return ModuleManager.reach != null && ModuleManager.reach.isEnabled() && passesChance();
    }
    ...
    private static boolean passesChance() {
        ...
        double chanceValue = chance.getInput();
        if (chanceValue <= 0.0D) {
            return false;
        }
        return chanceValue >= 100.0D || Math.random() < chanceValue / 100.0D;
    }
