...
import keystrokesmod.module.impl.combat.SilentAura;
...
public class TargetHUD extends Module {
    ...
    public TargetHUD() {
        ...
        this.registerSetting(new DescriptionSetting("Shows Kill Aura, Silent Aura, or crosshair target."));
    ...
    public void onRenderTick(TickEvent.RenderTickEvent ev) {
        ...
        if (ev.phase == TickEvent.Phase.END) {
            ...
            EntityLivingBase active = resolveActiveTarget();
            if (active != null) {
                target = active;
    ...
    private EntityLivingBase resolveActiveTarget() {
        ...
        if (SilentAura.getCrosshairTarget() != null) {
            return SilentAura.getCrosshairTarget();
        }
        if (mc.objectMouseOver != null
                && mc.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.ENTITY) {
            Entity hit = mc.objectMouseOver.entityHit;
            if (hit instanceof EntityLivingBase && hit != mc.thePlayer) {
